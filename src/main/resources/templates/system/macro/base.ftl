...
<header class="main-header">
    <a href="index2.html" class="logo">
        <span class="logo-mini"><b>Jinzunyue</b></span>
        <span class="logo-lg"><b>Jinzunyue</b></span>
    </a>
                ...
                <li class="dropdown user user-menu">
                    <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="adminlte/dist/img/user2-160x160.jpg" class="user-image" alt="User Image"> <span
                            class="hidden-xs">电厂安全测评报告系统</span>
                    </a>
...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023年毕设 <a href="https://github.com/babylikebird/common-admin">Jinzunyue</a>.
