...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(DefaultWebSecurityManager securityManager) {
         ...
         * 测试url不拦截
         */
        chains.put("/criterion/uploadExcel","anon");
        chains.put("/criterion/getClaList","anon");
        chains.put("/criterion/**","anon");
        chains.put("/criterion/getTypeListByCla","anon");
        chains.put("/reportItem/**","anon");
        chains.put("/report/**","anon");
        chains.put("/project/**","anon");
        chains.put("/recognize","anon");
        chains.put("/detect_assets","anon");
